...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://github.com/kandation/testss/releases/download/1.0/synthesis.pt", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://github.com/kandation/testss/releases/download/1.0/mapping.pt", cache_dir=cache_dir, verbose=verbose) as f:
